            ...
            return(
              <li key={id} className="w-full flex flex-row justify-between items-center gap-2.5 rounded-md even:bg-gray-200">
                ...
                <div className="flex flex-row h-10 w-[10%]">
                  <button onClick={() => openModal('patch', product)} className=' editBtn flex items-center justify-center w-8 h-full'>
                  ...
                  <button onClick={() => openModal('remove', product)} className='removeBtn flex items-center justify-center w-8 h-full'>
