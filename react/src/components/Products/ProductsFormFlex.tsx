          ...
          {productsList.map(product => {
            ...
            return(
              <li key={id} className="w-full h-20 flex flex-row justify-between items-center gap-2.5 rounded-md even:bg-gray-200">
                <div onClick={() => openModal({type: 'view', product})} className="w-full flex flex-row justify-between items-center gap-2.5 rounded-md">
                ...
                <div className="flex flex-row h-10 w-[10%]">
                  <button onClick={() => openModal({type: 'patch', product})} className=' editBtn flex items-center justify-center w-8 h-full'>
                  ...
                  <button onClick={() => openModal({type: 'remove', product})} className='removeBtn flex items-center justify-center w-8 h-full'>
